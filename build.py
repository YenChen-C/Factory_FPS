...
(P/'dist/Factory_Defense_S1.10.html').write_text(html.replace('S1.1','S1.10'))
...
(P/'dist/Factory_Models_S1.10.html').write_text(viewer)

(P/'Factory_Defense_S1.10.html').write_bytes((P/'dist/Factory_Defense_S1.10.html').read_bytes())
(P/'index.html').write_text('<!doctype html><html lang="en"><meta charset="utf-8"><meta http-equiv="refresh" content="0;url=Factory_Defense_S1.10.html"><title>Factory Defense</title><a href="Factory_Defense_S1.10.html">Play Factory Defense S1.10</a></html>')
